...
public class UserService {
    ...
    static {
        users.add(new User(1L, "Sang", new Date(), "1234" , "111111-12345678"));
        users.add(new User(2L, "Min", new Date(),  "1234" , "111111-12345678"));
        users.add(new User(3L, "Bong", new Date(), "1234" , "111111-12345678"));
    }
